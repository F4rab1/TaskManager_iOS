...
class LoginView: UIView {
    ...
    func setupConstraints() {
        ...
        loginGoogleButton.snp.makeConstraints { make in
            make.top.equalTo(lineLeft.snp.bottom).offset(30)
            make.leading.trailing.equalToSuperview().inset(15)
            make.height.equalTo(50)
        }
        
        googleIcon.snp.makeConstraints { make in
            make.top.equalTo(loginGoogleButton.snp.top).inset(12)
            make.leading.equalTo(loginGoogleButton.snp.leading).inset(16)
            make.width.equalTo(26)
            make.bottom.equalTo(loginGoogleButton.snp.bottom).inset(12)
        }
